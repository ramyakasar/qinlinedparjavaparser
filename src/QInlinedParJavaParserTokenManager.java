/* QInlinedParJavaParserTokenManager.java */
/* Generated By:JavaCC: Do not edit this line. QInlinedParJavaParserTokenManager.java */
import syntaxtree.*;
import java.util.Vector;

/** Token Manager. */
@SuppressWarnings ("unused")
public class QInlinedParJavaParserTokenManager implements QInlinedParJavaParserConstants {
...
static private void jjCheckNAddStates(int start, int end)
{
   do {
    ...
    /** Constructor. */
    public QInlinedParJavaParserTokenManager(JavaCharStream stream){
  ...
  /** Constructor. */
  public QInlinedParJavaParserTokenManager (JavaCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
